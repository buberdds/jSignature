...
jSignature v2 "2016-04-15T09:40" "commit ID e23434b81c60404c50ff436a7c08fb929a95d5f1"
...
this.drawEndHandler=function(b){if(!a.settings.readOnly){try{b.preventDefault()}catch(c){}g.clear();a.dataEngine.endStroke()}};this.drawStartHandler=function(k){if(!a.settings.readOnly){k.preventDefault();var e=$(a.canvas).offset();b=-1*e.left;c=-1*e.top;a.dataEngine.startStroke(d(k));g.kick()}};this.drawMoveHandler=function(b){a.settings.readOnly||(b.preventDefault(),a.dataEngine.inStroke&&(a.dataEngine.addToStroke(d(b)),g.kick()))};return this}.call({},this);(function(a,b,c){var d=this.canvas,k=
$(d);this.isCanvasEmulator?(k.bind("mousemove.jSignature",c),k.bind("mouseup.jSignature",a),k.bind("mousedown.jSignature",b)):(d.addEventListener("touchstart",function(k){d.onmousedown=d.onmouseup=d.onmousemove=void 0;this.fatFingerCompensation=g.minFatFingerCompensation&&-3*g.lineWidth>g.minFatFingerCompensation?-3*g.lineWidth:g.minFatFingerCompensation;b(k);this.addEventListener("touchmove",function(a){c(a)});this.addEventListener("touchend",function(b){a(b)})}),d.onmousedown=function(k){d.ontouchstart=
d.ontouchend=d.ontouchmove=void 0;b(k);d.onmousedown=b;d.onmouseup=a;d.onmousemove=c},window.navigator.msPointerEnabled&&(d.onmspointerdown=b,d.onmspointerup=a,d.onmspointermove=c))}).call(this,d.drawEndHandler,d.drawStartHandler,d.drawMoveHandler);b["jSignature.windowmouseup"]=k.subscribe("jSignature.windowmouseup",d.drawEndHandler);this.events.publish("jSignature.attachingEventHandlers");r.call(this,this,g.width.toString(10),"jSignature",k);this.resetCanvas(g.data);this.events.publish("jSignature.initialized");
return this}function z(b){if(b.getContext)return!1;var a=b.ownerDocument.parentWindow,c=a.FlashCanvas?b.ownerDocument.parentWindow.FlashCanvas:"undefined"===typeof FlashCanvas?void 0:FlashCanvas;if(c){b=c.initElement(b);c=1;a&&a.screen&&a.screen.deviceXDPI&&a.screen.logicalXDPI&&(c=1*a.screen.deviceXDPI/a.screen.logicalXDPI);if(1!==c)try{$(b).children("object").get(0).resize(Math.ceil(b.width*c),Math.ceil(b.height*c)),b.getContext("2d").scale(c,c)}catch(d){}return!0}throw Error("Canvas element does not support 2d context. jSignature cannot proceed.");
...
k.lineJoin="round";if(d.signatureLine){if(null!=d["decor-color"]){k.strokeStyle=d["decor-color"];k.shadowOffsetX=0;k.shadowOffsetY=0;var l=Math.round(t/5);A(k,1.5*l,t-l,h-1.5*l,t-l)}k.strokeStyle=d.color;g||(k.shadowColor=k.strokeStyle,k.shadowOffsetX=.5*k.lineWidth,k.shadowOffsetY=-.6*k.lineWidth,k.shadowBlur=0)}b||(b=[]);k=this.dataEngine=new m(b,this,E,f,e);d.data=b;$(c).data("jSignature.data",b).data("jSignature.settings",d);k.changed=function(a,b,c){return function(){b.publish(c+".change");a.trigger("change")}}(this.$parent,
